...
<div class="lt-recipe" id="lt-recipe" itemscope itemtype="http://schema.org/Recipe">
    ...
    <div class="recipe-info">
        ...
        <?php } ?>
<?php if($wine != '') { ?>
            <div class="wine"><i class="fa fa-glass"></i> <label><?php _e('Wine Pairing', 'kale'); ?></label>: <?php echo esc_html($wine) ?></div>
        <?php } ?>
    </div>
    <?php } ?>
    <?php if($print == 'yes') { ?>
    ...
    <?php if($image != '') { ?>
    <div class="recipe-image"><img itemprop="image" src="<?php echo esc_url($image); ?>" alt="<?php the_title_attribute(); ?>" class="img-responsive" /></div>
    <?php } ?>
<?php if($image2 != '') { ?>
    <div class="recipe-image"><img itemprop="image2" src="<?php echo esc_url($image2); ?>" alt="<?php the_title_attribute(); ?>" class="img-responsive" /></div>
    <?php } ?>
<?php if($image3 != '') { ?>
    <div class="recipe-image"><img itemprop="image3" src="<?php echo esc_url($image3); ?>" alt="<?php the_title_attribute(); ?>" class="img-responsive" /></div>
    <?php } ?>
    <div class="row">
    <?php if($ingredients != '') { 
